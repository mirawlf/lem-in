...
t_room					*best_room(t_room *current, t_room *variant,
										t_main *map);
...
void					auxiliary2(t_room *from, t_room *where, t_link *link,
										t_main *map);
int						has_link(t_room *current, t_room *possible,
										t_link *linklist);
...
t_room					*new_prev_room(t_room *current, t_path *starts,
										t_link *linklist);
t_room					*new_next_room(t_room *current, t_path *ends,
										t_link *linklist);
